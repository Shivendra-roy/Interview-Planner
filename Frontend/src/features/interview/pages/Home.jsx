                            ...
                            {uploadedFile ? (
                                <div className='upload-success'>
                                    <span className='upload-success__icon'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><polyline points="20 6 9 17 4 12" /></svg>
                                    </span>
                                    <div className='upload-success__text'>
                                        <p className='upload-success__title'>Resume Uploaded Successfully</p>
                                        <p className='upload-success__filename'>{uploadedFile}</p>
                                    </div>
                                    <button
                                        type='button'
                                        className='upload-success__change-btn'
                                        onClick={() => {
